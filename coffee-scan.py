...
if os.getuid() != 0:
    # Si no se ejecuta como administrador, ejecutar el script con privilegios de administrador
    osascript = '''
    do shell script "{sys.executable} {args}" with administrator privileges
    '''
    script = osascript.format(sys=sys, args=" ".join(sys.argv))
